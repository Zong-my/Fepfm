...
try:
    ...
    from .features_select import features_select
    ...
    from .evaluation import mae_loss, mape_loss, rmse_loss, smape_loss
except ImportError:
    from visualization import plot_prediction
    from features_select import features_select
    from gbdt_based_models import (
...
def main():
    global X1_val, X2_val, y1_val, y2_val
    global nthreads, pop, rt, timestamp_str, tmp_pred_y1, tmp_pred_y2
